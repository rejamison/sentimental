...
# obtain audio from a test WAV file
log("initializing recognizer")
log("loading file #1")
r = sr.Recognizer()
with sr.AudioFile("/home/pi/sentimental/test.wav") as f:
	callback(r, r.record(f))
log("loading file #2")
with sr.AudioFile("/home/pi/sentimental/test.wav") as f2:
        callback(r, r.record(f2))
log("finished")
